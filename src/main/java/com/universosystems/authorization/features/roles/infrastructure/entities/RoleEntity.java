package com.universosystems.authorization.features.roles.infrastructure.entities;
...
@Entity
@Table(name = "roles",
        uniqueConstraints = @UniqueConstraint(name = "uk_roles_app_code", columnNames = { "id_app", "code" }))
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class RoleEntity {
    ...
    private RoleStatusEntity status;
